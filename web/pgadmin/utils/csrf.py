...
class _PGCSRFProtect(CSRFProtect):
    ...
    def _pg_csrf_exempt(self, app):
        ...
        exempt_views = [
            ...
            'pgadmin.tools.schema_diff.api_compare',
            'pgadmin.tools.schema_diff.api_object_diff',
            'pgadmin.tools.schema_diff.api_migration_sql',
            'pgadmin.tools.schema_diff.api_migration_sql_test',
