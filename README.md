...
## Local Custom Changes Record

The following files were added or modified in this workspace for the
schema-diff API integration and local management/testing flow:

- Modified: `web/pgadmin/tools/schema_diff/__init__.py`
- Modified: `web/pgadmin/tools/schema_diff/templates/schema_diff/manager.html`
- Added: `web/pgadmin/tools/schema_diff/templates/schema_diff/manager_migration.html`
- Modified: `web/pgadmin/utils/csrf.py`
- Modified: `docs/en_US/schema_diff.rst`
- Added: `web/config_local.py`
